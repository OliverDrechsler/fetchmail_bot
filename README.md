[![ci build and test code](https://github.com/OliverDrechsler/fetchmail_bot/actions/workflows/ci.yml/badge.svg)](https://github.com/OliverDrechsler/fetchmail_bot/actions/workflows/ci.yml)
